    ...
    override fun onUpdate(context: Context?, appWidgetManager: AppWidgetManager?, appWidgetIds: IntArray?) {
      //login
        ...
        appWidgetIds?.forEach {
            ...
            val views: RemoteViews = RemoteViews(context?.packageName, R.layout.layout_widget2)
...
//            views.setOnClickPendingIntent(R.id.btnTop)
    ...
    inner class MyAsyncTop(val context: Context?) :
        ...
        override fun onPostExecute(result: String?) {
           ...
           AppWidgetManager.getInstance(context).updateAppWidget(ComponentName(context!!, AppWidget2::class.java), views)
